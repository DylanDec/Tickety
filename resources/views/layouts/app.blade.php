...
<head>
    ...
    <!-- BEGIN ALERTS CSS -->
    <link href="{{ asset('core/plugins/sweetalerts/sweetalert2.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('core/plugins/sweetalerts/sweetalert.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('core/assets/css/components/custom-sweetalert.css') }}" rel="stylesheet" type="text/css">
    <!-- END ALERTS CSS -->
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <ul class="navbar-nav theme-brand flex-row  text-center">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    <img src="core/assets/img/90x90.jpg" class="navbar-logo" alt="logo">
                </a>
            </li>
...
<script src="core/assets/js/libs/jquery-3.1.1.min.js"></script>
<script src="core/bootstrap/js/popper.min.js"></script>
<script src="core/bootstrap/js/bootstrap.min.js"></script>
<script src="core/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
...
<!-- BEGIN ALERTS SCRIPTS -->
<script src="{{ asset('core/plugins/sweetalerts/sweetalert2.min.js') }}"></script>
<script src="{{ asset('core/plugins/sweetalerts/custom-sweetalert.js') }}"></script>
<!-- END ALERTS SCRIPTS -->
